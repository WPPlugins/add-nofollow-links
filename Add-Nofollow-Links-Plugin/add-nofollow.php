...
Plugin URI: http://www.theonlydevice.com
Description: Add Nofollow searches for links to large websites that use the 'nofollow' tags for external links, and puts the same tag on your links to those sites. 
Author: Alan Carr
Version: 1.0
Author URI: http://www.theonlydevice.com
*/

/*	Copyright 2008	Alan Carr (email: alan@theonlydevice.com)
...
function wp_add_nofollow_insert_link() {
	echo ('<p>Bored? Watch <a href="http://www.theonlydevice.com">Free Movies</a>.</p>');
}
